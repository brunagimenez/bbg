const formEmailHTML = (username, password) => {
    return `
        <!DOCTYPE html>
        <html lang="pt">
        <head>
        ...
        <body style="font-family: 'Arial', sans-serif; text-align: center; background-color: #f4f4f4; padding: 20px;">
            ...
            <div style="background: linear-gradient(to bottom left,#FFCC70, #C850C0,#8455D3, #435bd0); max-width: 600px; margin: 0 auto; border-radius: 10px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
                ...
                <main style="padding: 20px; display: flex; flex-direction: column; align-items: center;">
                    ...
                    <h2 style="background-color: #4158D0; color: white; font-size: 20pt; padding: 0% 3%;">Informações de Login</h2>
            
                    <div style="margin-top: 20px; font-size: 18px; text-align: center; color: #d3d3d3;">
                        <p>Username:<spam style="color: #000000;"> ${username}</spam></p>
                        <p>Password:<spam style="color: #000000;"> ${password}</spam></p>
                    </div>
